function handleGithubOnclick(e) {
    e.preventDefault();
    window.open('https://github.com/nathanphan26', '_blank');
}

function handleLinkedinOnclick(e) {
    e.preventDefault();
    ...
    return (
        <footer class="fixed inset-x-0 bottom-0 pt-4 pr-4 pl-4 pb-6">
            <div class="flex flex-wrap float-right gap-2">
                ...
                {/* Github */}
                <button class="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded socials" onClick={handleGithubOnclick}>
